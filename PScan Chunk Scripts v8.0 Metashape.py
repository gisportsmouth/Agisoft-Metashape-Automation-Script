...
class MS_Proc(object):
    ...
    def info(self):
        ...
        print('The current matching accuracy is: {}'
                .format(self.match_dict[self.match_acc]))
        print('The current depth map quality is: {}'
                .format(self.depth_dict[self.depth_qual]))
    ...
    def grad_sel_preGCP(self, *, rec_uncert=None,
        ...
        for _ in self.chunks:
            ...
            print('Ties remaining after optimisation: {}'.
                    format(len([i for i in _.tie_points.points])))
            #2 ProjAcc
        ...
        for _ in self.chunks:
            ...
            with open(self.log, 'a+') as logfile:
                ...
                try:
                    ...
                    _.exportPointCloud(path = os.path.join(self.path, file),
